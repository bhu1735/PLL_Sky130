...
- [Day 2: Simulations](#day-2-simulations):  
  ...
  - [Post-Layout Simulations](#post-layout-simulations)  
    - [Phase-Frequency Detector (PFD)](#phase-frequency-detector-pfd-4)  
    - [Charge Pump (CP)](#charge-pump-cp-4)  
    - [Voltage Controlled Oscillator (VCO)](#voltage-controlled-oscillator-vco-4)  
    - [Frequency Divider (FD)](#frequency-divider-fd-4)  
    - [PLL System](#pll-system)  
  - [Tapeout](#tapeout)  
